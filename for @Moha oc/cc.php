...
// @Mod_By_Kamal
    ...
    public function processPayment() {
        ...
        $postFields = [
            ...
            'payment' => [
                ...
                'credit_card' => [
                    ...
                    'number' => $this->generateRandomCreditCardNumber(),
        ...
        if (isset($response['errors']) && $response['errors'][0]['code'] === 'transaction_declined') {
            ...
            // For demonstration purposes, we'll simulate a declined payment
...
$checkout = new BikeAttackCheckout();
